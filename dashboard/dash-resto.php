<?php
  ...
  $sql            = "SELECT * from (										
                      SELECT 
                        ...
                        , case when k.`status` = 'on progress'
                            then 0 else 1
                          end sort_prioritas
                      FROM keluhan k
                      ...
                      where k.status in ('on progress', 'done')
                      and k.outlet_pembelian = '".$_SESSION['resto']."'
                    ) d
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h5>DataTables Cutomenr Complain</h5>
                  <p>RESTO <?php echo $_SESSION['resto_nama'] ?></p>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">                                       <i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">Data Tables</li>
                    <li class="breadcrumb-item active">Cutomenr Complain</li>
                  </ol>
                </div>
              </div>
            </div>
